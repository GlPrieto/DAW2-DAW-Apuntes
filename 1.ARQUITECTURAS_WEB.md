...
Notas:
Azul --> Enrutadores
Gris --> Servidores/Clientes
Cada protocolo tiene su función
`
...
`
Notas:
HyperTextTrasferProtocol
Servidor de nombres (DNS)
RIP: de enrutadores.
OpenShortPass...Rápida
BGP: protocolo de pasarela frontera. Para comunicarse entre distintas redes.
`
...
`
Notas:Formato que tiene cada recurso en internet.
`
...
`
Notas: IMPORTANTE. La vertical (BD Relacionales) ya no se lleva. Se lleva la horizontal (BD noSQL), para dividir el trabajo.
`
